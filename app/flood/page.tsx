                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-gradient-to-r from-blue-900/40 to-blue-800/30 rounded-xl p-6 shadow-lg mb-6">
                    <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
                      ...
                      AI-Driven Flood Forecast
                    </h2>
                    <p className="text-gray-300 mb-4">
                      Our advanced system analyzes real-time rainfall data, river sensor readings, terrain models, and
                      official weather forecasts to generate flood risk assessments. These forecasts are updated hourly
                      using machine learning algorithms trained on historical hydrological patterns.
                    </p>
                    <div className="bg-slate-800/60 p-4 rounded-lg">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Based on the highest alert level issued for any of the regions below.
                      </p>
                    </div>
                  </div>
                      ...
                      >
                        ...
                        <div className="mt-2 space-y-1 text-sm">
                          <div className="flex justify-between">
                            <span className="text-gray-400">24hr Rainfall Fcst:</span>
                        ...
                        <div className="mt-3 w-full bg-slate-700 rounded-full h-1.5">
                          <div
                            ...
                            style={{
                              width: `${prediction.riskLevel === "High" ? 100 : prediction.riskLevel === "Moderate" ? 60 : 30}%`,
                            }}
                          ></div>
                        </div>
                      </motion.div>
                  ...
                  <div className="mt-6 text-xs text-gray-500">
                    <p>
                      Last updated: September 25, 2025 at 9:48 PM. Predictions are based on machine learning models and
                      should be used as guidance only. Always follow official emergency instructions.
                    </p>
                  </div>
                </div>
              </motion.div>
