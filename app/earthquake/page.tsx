  ...
  const predictionData = [
    {
      ...
      lastEvent: "1.9 Mag, 3 days ago",
      activity: "2 tremors",
    },
    {
      region: "Kalaburagi Region",
      seismicZone: "Zone III (Moderate Risk)",
      lastEvent: "2.5 Mag, 14 days ago",
      activity: "5 tremors",
    },
    {
      region: "Kodagu & Hassan Region",
      seismicZone: "Zone II (Low Risk)",
      lastEvent: "1.7 Mag, 28 days ago",
      activity: "1 tremor",
    },
    {
      region: "Ballari & Chitradurga",
      seismicZone: "Zone II (Low Risk)",
      lastEvent: "2.1 Mag, 45 days ago",
      activity: "1 tremor",
    },
  ]
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-gradient-to-r from-orange-900/40 to-orange-800/30 rounded-xl p-6 shadow-lg mb-6">
                    ...
                    <p className="text-gray-300 mb-4">
                      Our system analyzes real-time seismic data from observatories within Karnataka, historical
                      patterns, and regional geology to assess current hazard levels and provide immediate information
                      on local seismic events.
                    </p>
                    <div className="bg-slate-800/60 p-4 rounded-lg">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Based on the Karnataka State seismic monitoring network
                      </p>
                    </div>
                  </div>
