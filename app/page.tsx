...
export default function DisasterManagementApp() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      <motion.div
        className="relative bg-slate-900/90 backdrop-blur-xl border-t border-slate-700/50 p-3"
        initial={{ y: 100 }}
        animate={{ y: 0 }}
                  ...
                  <div className="flex-1">
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="mb-3">
                      <Button
                        ...
                        onClick={() =>
                          window.open("https://zoom.earth/maps/wind-speed/#view=14.49,80.05,5z/model=icon", "_blank")
                        }
                      >
...
function ProfileSection({
  ...
  const [emergencyContacts, setEmergencyContacts] = useState([
    { name: "Rajesh Kumar", relation: "Self", phone: "+91 98765-43210" },
      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-red-900/20 to-red-800/10 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-white mb-1">Rajesh Kumar</h2>
        ...
        {activeTab === "notifications" && (
          ...
          >
            <motion.div
              ...
              className="relative overflow-hidden bg-slate-800/60 border border-slate-700/50 shadow-2xl rounded-2xl backdrop-blur-sm"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-slate-700/20 to-transparent"></div>
              <div className="relative p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-bold text-white text-lg">{t("notificationPreferences")}</h3>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-slate-700/40 rounded-2xl p-6 border border-slate-600/30 backdrop-blur-sm">
                    ...
                    <div className="space-y-4">
                      <motion.div
                        className="flex items-center justify-between p-3 bg-slate-800/30 rounded-xl border border-slate-600/20"
                        whileHover={{ scale: 1.02 }}
                      >
                        <div className="flex items-center gap-3">
                          <MessageSquare className="h-5 w-5 text-blue-400" />
                          <div>
                            <span className="text-white font-medium">{t("smsNotifications")}</span>
                            <div className="text-xs text-slate-400">{t("receiveAlertsViaSMS")}</div>
                          </div>
                        </div>
                        <Switch
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-slate-400">{t("receiveAlertsViaEmail")}</div>
                          </div>
                        </div>
                        <Switch
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-slate-400">{t("instantAlerts")}</div>
                          </div>
                        </div>
                        <Switch
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-white font-medium">{t("earthquakeAlerts")}</span>
                            <div className="text-xs text-slate-400">{t("seismicActivity")}</div>
                          </div>
                        </div>
                        <Switch
                          checked={notificationPreferences.earthquake}
                          onCheckedChange={() => toggleNotification("earthquake")}
                        />
                      </motion.div>
                      <motion.div
                        className="flex items-center justify-between p-3 bg-slate-800/30 rounded-xl border border-slate-600/20"
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-white font-medium">{t("floodAlerts")}</span>
                            <div className="text-xs text-slate-400">{t("waterLevelWarnings")}</div>
                          </div>
                        </div>
                        <Switch
                          checked={notificationPreferences.flood}
                          onCheckedChange={() => toggleNotification("flood")}
                        />
                      </motion.div>
                      <motion.div
                        className="flex items-center justify-between p-3 bg-slate-800/30 rounded-xl border border-slate-600/20"
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-white font-medium">{t("fireAlerts")}</span>
                            <div className="text-xs text-slate-400">{t("fireHazardWarnings")}</div>
                          </div>
                        </div>
                        <Switch
                          checked={notificationPreferences.fire}
                          onCheckedChange={() => toggleNotification("fire")}
                        />
                      </motion.div>
                      <motion.div
                        className="flex items-center justify-between p-3 bg-slate-800/30 rounded-xl border border-slate-600/20"
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-white font-medium">{t("weatherAlerts")}</span>
                            <div className="text-xs text-slate-400">{t("severeWeatherNotifications")}</div>
                          </div>
                        </div>
                        <Switch
                  ...
                  <div className="bg-slate-700/40 rounded-2xl p-6 border border-slate-600/30 backdrop-blur-sm">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-white">{t("alertMeWithin")}</span>
                      </div>
                      <div className="px-3">
            ...
            >
              ...
              <div className="relative p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-bold text-white text-lg">{t("emergencyInformation")}</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <div className="space-y-4 text-gray-300">
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        ...
                        <span className="font-medium text-white">Penicillin</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("medicalConditions")}:</span>
                        <span className="font-medium text-white">Asthma</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("medications")}:</span>
                        <span className="font-medium text-white">Albuterol Inhaler</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("lastCheckup")}:</span>
                        <span className="font-medium text-white">March 15, 2025</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="space-y-4 text-gray-300">
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("primaryShelter")}:</span>
                        <span className="font-medium text-white">Mangaluru Town Hall</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("secondaryShelter")}:</span>
                        <span className="font-medium text-white">St. Aloysius College</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("evacuationRoute")}:</span>
                        <span className="font-medium text-white">Route B (Coastal)</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-slate-800/30 rounded-lg">
                        <span className="text-slate-400">{t("meetingPoint")}:</span>
                        <span className="font-medium text-white">City Center Mall</span>
                      </div>
                    </div>
                  </motion.div>
